...
<div id="{{ $id }}" class="kpi-card"
    ...
    <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:8px">
        ...
        <div style="display:flex; align-items:center; gap:8px">
            <a href="{{ route('maintenances.index') }}" aria-label="Go to Maintenances" title="Go to Maintenances"
                style="display:inline-flex; align-items:center; background:transparent; border:none; padding:6px; border-radius:6px; cursor:pointer; color:{{ $textColor }}; text-decoration:none;">
